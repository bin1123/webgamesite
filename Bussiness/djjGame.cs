...
namespace Bussiness
{
    public class djjGame
    {
        private const string key = "jrYE_rMs_QupeaLV";
        ...
        public static string Login(string sUserID, string sGame)
        {
            ...
            string sAuth = string.Format("op_id={0}&sid={1}&game_id=7&account={2}&adult_flag=1&time={3}",op_id,sid,account,time);
        ...
        public static string Pay(string sUserID, decimal dMoney, string sOrderID, string sGame)
        {
            ...
            string time = ProvideCommon.getTime().ToString();
            string sAuth = string.Format("op_id={0}&sid={1}&game_id=7&account={2}&order_id={3}&game_money={4}&u_money={5}&time={6}",
        ...
        public static string djjPay(string sGameAbbre, int iUserID, string sUserName, int iPayPoints, string sPhone, int iGUserID)
        {
        ...
        public static string djjQucikPay(string sGameAbbre, string sUserName, decimal dPrice, string sTranID)
        {
        ...
        {
            string sServerID = sGame.Replace("djj", "");
            int sBeginServerID = 115070000;
            int iSID = 1;
