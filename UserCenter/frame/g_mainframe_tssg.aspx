<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="g_mainframe_tssg.aspx.cs" Inherits="UserCenter.frame.g_mainframe_tssg" %>
<html>
...
<frameset framespacing="0" border="0" frameborder="no" cols="110, 10, *" rows="*" name="f3" id="frame-body">
	<frame scrolling="no" noresize="noresize" name="leftFrame" src="g_left_nav_tssg.aspx"></frame>
	<frame scrolling="no" noresize="noresize" name="leftFrame" src="scroller.aspx"></frame>
	<frame scrolling="auto" noresize="noresize" id="mainFrame" name="mainFrame" src="../GCenter/ToGame.aspx?gn=<%=sGame %>&fuid=<%=fuid %>"></frame>
</frameset>
</frameset>
<noframes>
<body> 
