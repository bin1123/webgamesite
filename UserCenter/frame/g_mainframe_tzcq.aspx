<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="g_mainframe_tzcq.aspx.cs" Inherits="UserCenter.frame.g_mainframe_tzcq" %>
...
<frameset framespacing="0" border="0" frameborder="no" cols="110, 10, *" rows="*" name="f3" id="frame-body">
	<frame scrolling="no" noresize="noresize" name="leftFrame" src="g_left_nav_tzcq.aspx"></frame>
