<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PayGSucc.aspx.cs" Inherits="UserCenter.Pay.PayRes" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title>到武林_游戏兑换成功</title>    
...
<div id="wrap"><!--wrap开始-->
    ...
    <div id="chongzhi07">
    <p>恭喜！<%=sGameName %>充值成功！</p>
    <p>消费账号:<%=sAccount %></p>
    <p>充值账号:<%=sPayAccount %></p>
    <p>充值成功：<span><%=iGamePoints %></span><%=sGameM %></p>
    <p>消费账户的余额：<span><%=iUserPoints %></span>武林币</p>
