<%@ Page Language="C#" Buffer="true" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="UserCenter.Pay.PIndex" %>
...
<div id="wrap"><!--wrap开始-->
    ...
    <ul>
    <li>
    <span class="m01">充值中心 > 平台充值</span>
    </li>
    </ul>
    </div>
    <div id="cz_right"><!--充值成功内容开始-->
    <form id="form1">
    <div id="chongzhi01"><!--chongzhi01开始-->
                       <div class="chongzhi02" ><!--兑换武林币开始-->
                        <a href="#" onclick="show('GamePay')"><img src="<%=sWebUrl %>/wldFolder/images/duihuanwlb.jpg" border="0" /></a>
                      </div>
                      <div id="wlbpay" class="chongzhi02"><!--游戏充值开始-->
                        <a href="#" onclick="show('pay')"><img src="<%=sWebUrl %>/wldFolder/images/youxichongzhi.jpg" border="0" /></a>
                      </div>
                      <div id="payinfos" class="chongzhi03">
                        <div id="chongzhi03_left">
                          <ul>
                          <li id="ibank" class="cz_bg2"><a href="#" onclick="PayChange('ibank');return false;">网上银行支付</a></li>
                          <li id="alipay" class="cz_bg1"><a href="#" onclick="PayChange('alipay');return false;">支付宝支付</a></li>
                          <li id="szfphone" class="cz_bg1"><a href="#" onclick="PayChange('szfphone');return false;">手机充值卡支付</a></li>
                          <li id="szfbank" class="cz_bg1"><a href="#" onclick="PayChange('szfbank');return false;">无网银银行卡支付</a></li>
                          <li id="tenpay" class="cz_bg1"><a href="#" onclick="PayChange('tenpay');return false;">财付通支付</a></li>
                          <li id="yp-bank" class="cz_bg1"><a href="#" onclick="PayChange('yp-bank');return false;">易宝网上银行支付</a></li>
                          <li id="vpay" class="cz_bg1"><a href="#" onclick="PayChange('vpay');return false;">座机支付（V币）</a></li>
                          <li id="yp-zt" class="cz_bg1"><a href="#" onclick="PayChange('yp-zt');return false;">征途卡支付</a></li>
                          <li id="yp-sd" class="cz_bg1"><a href="#" onclick="PayChange('yp-sd');return false;">盛大卡支付</a></li>
                          <li id="yp-jcard" class="cz_bg1"><a href="#" onclick="PayChange('yp-jcard');return false;">骏网一卡通支付</a></li>
                          <li id="yp-szx" class="cz_bg1"><a href="#" onclick="PayChange('yp-szx');return false;">神州行卡支付</a></li>
                          <li id="yp-dx" class="cz_bg1"><a href="#" onclick="PayChange('yp-dx');return false;">电信卡支付</a></li>
                          <li id="yp-lt" class="cz_bg1"><a href="#" onclick="PayChange('yp-lt');return false;">联通卡支付</a></li>
                          <li id="gnyhhk" class="cz_bg1"><a href="#" onclick="PayChange('gnyhhk');return false;">国内银行汇款</a></li>
                          </ul>
                        </div>
                        <div id="chongzhi03_right">
                          <div id="chongzhi03_right03">
                        ...
                        <div id="chongzhi03_right04">
                          ...
                          <li>
                            ...
                            <input type="radio" name="payto" onclick="payshow('pt')" id="paytopt" value="paytopt" />充值到平台<font color="#FF0000">（武林币）</font>
                          </li>
                          <span id="paytogameinfo">
                          <li>充值到游戏：
                              <select id="gamename" onchange="ServerSelOfGameVal('servername',this.value,'==请选择==');SetGamePoints();QuickPayVal()" style="width:150px;z-index:-1;">
                          ...
                          <li>充值金额：
                              <select id="payprice" onchange="SetGamePoints()" style="width:150px;">
                              ...
                              您可获得：<font id="gamepoints" color="#FF0000">1000元宝</font>
                          </li>
                          </ul>
                        ...
                        <div id="chongzhi03_right01">
                        <center><img alt="" onclick="openWindow('350','250');" src="<%=sWebUrl %>/wldFolder/images/querenzhongzhi.jpg" border="0" /></center>
                        </div>
                        </div>
                        <div id="gnyhinfo" style="display:none" class="chongzhi12">
                           <p><img src="<%=sWebUrl %>/wldFolder/images/lxfs.jpg" /></p>
                       <p>客服QQ：938019260 &nbsp;&nbsp;客服电话：400 008 5267（9：00-19：00）</p><br />
                       ...
                       <p>第3步、联系在线客服（客服QQ：938019260）以及客服电话。向充值客服提供准确的游戏账号,游戏名称,游戏区服,游戏角色,充值银行,充值金额,真实姓名。例如：游戏帐号：123456游戏名称：盛世三国游戏区服：[双线1服]烽火九州游戏角色：ABC充值银行：农业银行充值金额：100元 真实姓名：赵四</p>
                       ...
                       <p>C、通过在线联系方式联系充值客服（客服QQ：938019260）。需提供一下信息：A.监控号，发汇人名（Last name），发汇人姓（First name），发汇金额，发汇国家，发汇省，发汇城市，发汇地址街道，电话信息。B.游戏帐号、游戏名称、游戏区域、游戏角色。注：以上信息需全部正确填写才可充值成功</p>
                       ...
                       <p>A、人工充值需要www.dao50.com官方手动处理，务必正确告知客服（客服QQ：938019260）您需要充值的游戏帐号，游戏帐号填写错误导致的损失请自行承担！</p>
                      ...
                      <div id="gpayinfos" class="chongzhi03" style="display:none" >
                        ...
                        <div id="chongzhi03_right">
                          <div id="chongzhi03_right03">
                            <p><strong>您当前选择的是<font color="#CC0000";>“武林币兑换”</font>支付方式</strong></p>
                            <p>您可以使用武林币兑换，选择兑换到武林游戏平台旗下游戏的游戏币。</p>
                            </div>
                        ...
                        <div id="chongzhi03_right04">
                          ...
                          <li><img src="<%=sWebUrl %>/wldFolder/images/cz_bz2.jpg" /></li>
                          <li>充值到游戏：
                              <select id="ggamename" onchange="ServerSelOfGameVal('gservername',this.value,'==请选择==');SetGPoints();GamePayVal()" style="width:150px;z-index:-1;">
                              <option value="">==请选择==</option>
                          ...
                          <ul class="cz_01">
                          <li><img src="<%=sWebUrl %>/wldFolder/images/cz_bz3.jpg" /></li>
                          <li>账户余额：<font color="#FF0000"><%=iUserPoints %></font>武林币</li>
                          <li>充值数量：
                              <select id="gpaynums" onchange="SetGPoints()" style="width:150px;">
                                    <option value="80">80武林币</option>
                                    <option value="90">90武林币</option>
                                    <option value="100">100武林币</option>
                                    <option value="200">200武林币</option>
                                    <option value="300">300武林币</option>
                                    <option value="500">500武林币</option>
                                    <option value="1000">1000武林币</option>
                                    <option value="2000">2000武林币</option>
                                    <option value="3000">3000武林币</option>
                                    <option value="5000">5000武林币</option>
                                    <option value="6000">6000武林币</option>
                                    <option value="10000">10000武林币</option>
                                    <option value="20000">20000武林币</option>
                                    <option value="30000">30000武林币</option>
                                    <option value="50000">50000武林币</option>
                                    <option value="100000">100000武林币</option>
                              </select>
                          </li>
                        ...
                        <div id="chongzhi03_right01">
                        <center><img alt="" onclick="openWindow('350','250')" src="<%=sWebUrl %>/wldFolder/images/querenduihuan.jpg" border="0" /></center>
                        </div>
                        </div>
                      </div><!--兑换武林币结束-->
                    </div><!--chongzhi01结束-->
                    ...
                    <input type="hidden" id="islogin" name="islogin" value="<%=sIsLogin %>">
                    <input type="hidden" id="isgift" name="isgift" value="<%=sIsGift %>">
        </form>
    </div><!--充值成功内容结束-->
    <!--弹出层隐藏-->
     <div id="LockWindows"><br>
 <div class="WindowDIV" id="WindowDIV">   
  <div id="tanchuang" style="position:relative; z-index:+1">
    ...
    <div id="WlbNote" style="display:none" class="tanchuang02">
    <form name="bankpay" action="BankPay.ashx" method="post" target="_blank">
    <p class="text_small">&nbsp;</p>
    <p class="text_small">您要充值的账号：<span id="wlbaccount" class="f19"></span></p>
    <p class="text_small">您要充值的武林币：<span id="wlbnums" class="f19"></span></p>
    <p class="text_small">您所花费的金钱(元)：<span id="wlbmoney" class="f19"></span></p>
    <p><center><input type="submit" value="" class="queding" />
    <input type="button" value="" onclick="hiddenWindows()" class="fanhui" /></center></p>
    ...
    <form name="gamepay" action="PTPay.aspx" method="post" target="_blank">
    <p class="text_small">&nbsp;</p>
    <p class="text_small">您要充值的账号：<span id="gaccount" class="f19"></span></p>
    <p class="text_small">您要花费的武林币：<span id="gamewlbs" class="f19"></span></p>
    ...
    <form name="quickpay" action="QuickPay.ashx" method="post" target="_blank">    
    <p class="text_small">&nbsp;</p>
...
<script type="text/javascript" src="<%=sRootUrl %>/JsFolder/Login.js"></script>
<script type="text/javascript">
    $(document).ready(function() {
        var gameid = getUrlParam("game_id");
        if (gameid > 0) {
            GameAllSelCheck(gameid);
        }
        else {
            GameAllSelSgyjz();
        }
        var account = '<%=sUserName %>';
        var userpoint = '<%=iUserPoints %>';
        if (LoginVal(account)) {
            Logined(account, userpoint);
        }
    });
</script>